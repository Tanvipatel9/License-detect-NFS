...
plate_list = os.listdir('/home/vm6/Desktop/plate_photos')
print("TOTAL NUMBER OF PHOTOS: " + str(len(plate_list)) + "\n")

for plate in plate_list:

    img = cv2.imread('/home/vm6/Desktop/plate_photos/' + str(plate))
